...
/**
 * Created by nowus on 5/23/2016.
 */
public class CustomWishListAdapter  extends BaseAdapter implements SectionIndexer,Filterable {
    ...
    public CustomWishListAdapter(Context ctx,String[] items){
        this.ctx = ctx;
